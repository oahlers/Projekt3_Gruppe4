...
public class RentalRepository {
    ...
    public Rental findLatestByCarId(Long carId) {
        ...
        return jdbcTemplate.query(sql, this::mapRental, carId).stream().findFirst().orElse(null);
    }
    ...
    public List<Rental> findAllActive() {
        ...
        return jdbcTemplate.query(sql, this::mapRental);
    }
    ...
    // Rowmapper for Rental (flyttet fra DamageReportRepository)
    // [ Rasmus Guldborg Pedersen ] [ Oliver Ahlers ]
    public Rental mapRental(ResultSet rs, int rowNum) throws SQLException {
